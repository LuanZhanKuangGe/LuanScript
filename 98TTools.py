        ...
        for tbody in response.css("tbody"):
            if tbody.attrib.get('id'):
                if tbody.attrib['id'].find('normalthread') != -1:
                    ...
                    date_type = len(tbody.css("tr").css("td.by")[0].css("em").css("span"))
                    date = ''
                    if date_type == 1:
                        date = tbody.css("tr").css("td.by")[0].css("em").css("span::text").get()
                    elif date_type == 2:
                        date = tbody.css("tr").css("td.by")[0].css("em").css("span")[1].attrib['title']
                    else:
                        print("date error !!!!!!!!!!!!!!!!!!!")
                        exit(1)
